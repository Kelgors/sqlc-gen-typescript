...
function funcParamsDecl(argsIface: string | undefined, params: Parameter[]) {
  let funcParams = [
  ...
  if (argsIface && params.length > 0) {
    funcParams.push(
      factory.createParameterDeclaration(
        ...
        undefined,
        factory.createTypeReferenceNode(
          factory.createIdentifier(argsIface),
          undefined
        ),
        undefined
      )
    ...
    imports.push(
      factory.createInterfaceDeclaration(
        ...
        [
          factory.createPropertySignature(
            undefined,
            factory.createIdentifier("queryArray"),
            undefined,
                ...
                factory.createVariableDeclaration(
                  ...
                  factory.createAwaitExpression(
                    factory.createCallExpression(
                      ...
                      [
                        factory.createTupleTypeNode(columns.map((col) => this.columnType(col)))
                      ],
                      [
                        factory.createObjectLiteralExpression(
                          [
